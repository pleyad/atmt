...
def get_args():
    ...
    parser.add_argument('--file-path', default=None, metavar='PAT', help='path to the file')
    ...
    parser.add_argument('--mono-prefix', default=None, metavar='MO', help='mono file prefix')
...
def main(args):
    ...
    if args.mono_prefix is not None:
        make_binary_dataset(args.mono_prefix + '.' + args.source_lang, os.path.join(args.dest_dir, 'mono.' + args.source_lang), src_dict)

def build_dictionary(filenames, tokenize=word_tokenize, v=False):
